        ...
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddSwaggerGen(swagger =>
            {
                swagger.SwaggerDoc("v1", new OpenApiInfo
                {
                    ...
                    Description = (builder.Configuration["Swagger:Description"] ?? "API para gerenciamento de motos no pátio - ") + DateTime.Now.Year,
            ...
            // Exemplo de injeção de repositório (se estiver usando)
